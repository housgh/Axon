...
public class AxonSQLiteStoreTests(SQLiteFixture fixture)
{
    ...
    [Fact]
    public async Task DeleteCompletedJobsOlderThan_NeverDeletesFailedOrSkippedJobsAgainstRealSQLite()
    {
        var sut = CreateSut();
    ...
    [Fact]
    public async Task CountJobsByState_CountsSoftDeletedSucceededJobAgainstRealSQLite()
    {
