...
public class AxonPostgresStoreTests(PostgresFixture fixture)
{
    ...
    [Fact]
    public async Task DeleteCompletedJobsOlderThan_NeverDeletesFailedOrSkippedJobsAgainstRealPostgres()
    {
        var sut = CreateSut();
    ...
    [Fact]
    public async Task CountJobsByState_CountsSoftDeletedSucceededJobAgainstRealPostgres()
    {
