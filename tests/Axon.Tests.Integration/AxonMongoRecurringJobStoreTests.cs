...
public class AxonMongoRecurringJobStoreTests(MongoDbFixture fixture)
{
    private AxonMongoRecurringJobStore CreateSut() => new(fixture.ConnectionString, fixture.DatabaseName);
    ...
    public async Task GetAll_Take_LimitsResultCount()
    {
        ...
        // so this test's own 3 rows sort predictably relative to each other even though the
        // collection is shared with concurrently-running tests in this collection that may add
        // other documents.
        var sut = CreateSut();
