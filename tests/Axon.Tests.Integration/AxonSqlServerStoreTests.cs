...
public class AxonSqlServerStoreTests(SqlServerFixture fixture)
{
    ...
    [Fact]
    public async Task DeleteCompletedJobsOlderThan_NeverDeletesFailedOrSkippedJobsAgainstRealSqlServer()
    {
        var sut = CreateSut();
    ...
    [Fact]
    public async Task CountJobsByState_CountsSoftDeletedSucceededJobAgainstRealSqlServer()
    {
