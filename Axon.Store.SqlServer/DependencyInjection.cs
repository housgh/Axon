...
public static class DependencyInjection
{
    ...
    /// registry, and device-connection registry with SQL Server-backed implementations sharing
    ...
    /// <c>Axon.Store.SqlServer/Schema.sql</c> against it first. A store method throws
    /// <see cref="Axon.Server.Exceptions.AxonSchemaNotProvisionedException"/> if it hasn't been,
    /// or <see cref="Axon.Server.Exceptions.AxonStoreException"/> for any other SQL Server
